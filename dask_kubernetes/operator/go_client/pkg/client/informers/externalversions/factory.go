...
type SharedInformerFactory interface {
	...
	Kubernetes() kubernetesdaskorg.Interface
}

func (f *sharedInformerFactory) Kubernetes() kubernetesdaskorg.Interface {
	return kubernetesdaskorg.New(f, f.namespace, f.tweakListOptions)
}
